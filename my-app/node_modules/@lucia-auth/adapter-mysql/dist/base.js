export class MySQLAdapter {
    ...
    async updateSessionExpiration(sessionId, expiresAt) {
        await this.controller.execute(`UPDATE ${this.escapedSessionTableName} SET expires_at = ? WHERE id = ?`, [expiresAt, sessionId]);
    }
    async deleteExpiredSessions() {
        await this.controller.execute(`DELETE FROM ${this.escapedSessionTableName} WHERE expires_at <= ?`, [new Date()]);
    }
...
function transformIntoDatabaseSession(raw) {
    ...
    return {
        userId,
        id,
        expiresAt: expiresAtResult instanceof Date ? expiresAtResult : new Date(expiresAtResult + " GMT"),
        attributes
    };
}
